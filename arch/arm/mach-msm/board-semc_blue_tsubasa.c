/* arch/arm/mach-msm/board-semc_blue_tsubasa.c
 *
...
static struct pm8xxx_gpio_init pm8921_gpios[] __initdata = {
	...
	PM8XXX_GPIO_DISABLE(35),
#endif
#if defined(CONFIG_SEMC_FELICA_NFC_SUPPORT) && !defined(CONFIG_NFC_PN544)
	/* NFC_EXT_LDO_EN 2 */
...
/* TODO
 stock tsubasa use sdc_vdd_io but it require
 https://www.codeaurora.org/gitweb/quic/la/?p=kernel/msm.git;a=commit;h=3c4e3cd4954672618cbb5e3fbbafe737fc420d5a
...
/* TODO: add drivers/misc/smsc_hub.c
   https://www.codeaurora.org/gitweb/quic/la/?p=kernel/msm.git;a=history;f=drivers/misc/smsc_hub.c;h=9232f67d70424ebc779c36253be23e23e1d3347f;hb=refs/heads/ics_strawberry
...
static struct msm_gpiomux_config semc_blue_all_cfgs[] __initdata = {
	...
	/* GPIO59 follow QCT, configured in msm8960_audio_codec_configs below */

	/* GPIO60-61 follow QCT, configured in msm8960_slimbus_config below */
	...
	/* GPIO100-102 follow QCT, configured in msm8960_hdmi_configs below */
...
#ifdef CONFIG_SEMC_CAM_SUB_V4L2
	{
		I2C_BOARD_INFO("semc_sensor_sub", 0x3d),
...
const struct semc_sensor_module sensor_sub_modules[] = {
	{ "GENERIC",  0x3d, sensor_sub_power_on, sensor_sub_power_off },
	{ "APT00YP1", 0x3d, sensor_sub_power_on, sensor_sub_power_off },
	{ "STW00YP1", 0x3d, sensor_sub_power_on, sensor_sub_power_off },
};
/* END FIXME */
...
const int semc_sensor_sub_eeprom_addr = 0x3d;
