...
static struct double_row_lut rbatt_temp_soc = {
	...
	.in_1		= {-10, 0, 10, 20, 40},
	.in_2		= {
		{INT_MAX, INT_MAX, INT_MAX, 100, 100},
		{INT_MAX, INT_MAX, 100, 40, 0},
		{INT_MAX, 100, 94, 7, INT_MIN},
		{INT_MAX, 98, 57, 3, INT_MIN},
		{INT_MAX, 93, 7, 0, INT_MIN},
		{100, 88, 2, INT_MIN, INT_MIN},
		{98, 65, 0, INT_MIN, INT_MIN},
		{94, 5, INT_MIN, INT_MIN, INT_MIN},
		{90, 0, INT_MIN, INT_MIN, INT_MIN},
		{65, INT_MIN, INT_MIN, INT_MIN, INT_MIN},
		{8, INT_MIN, INT_MIN, INT_MIN, INT_MIN},
		{3, INT_MIN, INT_MIN, INT_MIN, INT_MIN},
		{0, INT_MIN, INT_MIN, INT_MIN, INT_MIN},
	},
	.out		= {130, 150, 170, 200, 250, 290, 310,
		370, 400, 520, 540, 550, 570
	},
};
